...
plt.plot(x_time, out_packets, '-', label='Out Packets')
plt.plot(x_time, out_octets, '-', label='Out Octets')
plt.plot(x_time, in_packets, '-', label='In Packets')
plt.plot(x_time, in_octets, '-', label='In Octets')
